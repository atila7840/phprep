...
<div id="lavosoli" class="modal">
  ...
  <form name="inputselector" class="modal-content animate" >
    ...
    <div class="container">
    <p align="center">
      <label class="farsifont">گزارش درآمد ناخالص کشور</label></p>
...
$query="select * from province order by PROV_FA_NAME";
...
?>
      ...
      <button type="submit" target="../wordpress/service/reportsPHP/incomekolekeshvar.php" class="farsifont btn" id="continue_form">ادامه</button>
