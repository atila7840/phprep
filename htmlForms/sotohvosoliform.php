...
<div id="lavosoli" class="modal">
  ...
  <form name="inputselector" class="modal-content animate" >
    ...
    <div class="container">
    <p align="center">
      <label class="farsifont">گزارش سطوح وصولی</label></p>
...
?>
      ...
      <button type="submit" target="../wordpress/service/reportsPHP/sotohvosoli.php" class="farsifont btn" id="continue_form">ادامه</button>
